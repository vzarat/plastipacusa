...
export const translations = {
  en: {
    ...
    "dashboard.valuedCustomer": "Valued Customer",
    "dashboard.greetingSubtitle":
      "Here’s a quick look at your commercial account and open opportunities.",
    "dashboard.promoCarouselLabel": "Account announcements",
    "dashboard.promoEyebrow": "Plastipac Updates",
    "dashboard.promoSlide": "Slide",
    "dashboard.promo1Title": "Exclusive B2B Offers",
    "dashboard.promo1Body":
      "Up to 15% off on bulk Machine Film orders.",
    "dashboard.promo1Cta": "View Machine Film",
    "dashboard.promo2Title": "Fast USA Shipping",
    "dashboard.promo2Body":
      "Guaranteed 48-hr dispatch across all US states.",
    "dashboard.promo2Cta": "Browse Catalog",
    "dashboard.promo3Title": "Net 30 Credit Line Available",
    "dashboard.promo3Body": "Apply today for flexible financing.",
    "dashboard.promo3Cta": "Apply for Credit",
    "dashboard.creditSlideBadge": "Commercial Credit",
    "dashboard.creditSlideTitle": "Apply for B2B Credit & Net 30 Terms",
    "dashboard.creditSlideSubtitle":
      "Streamline high-volume freight orders with dedicated lines of credit, PO checkout, and Net 30 terms for verified accounts.",
    "dashboard.creditSlideCta": "Start Credit Application",
    "dashboard.creditSlideBrowse": "Browse catalog while you apply →",
    "dashboard.sampleSlideBadge": "Free Sample",
    "dashboard.sampleSlideTitle": "Request Your Free Sample Roll",
    "dashboard.sampleSlideSubtitle":
    ...
    "admin.bentoFulfillmentSubtitle": "Active U.S. freight dispatches and yard queue",
    ...
    "products.rollLength": "Roll Length",
    ...
    "products.directCheckout": "Proceed to Direct Checkout",
    ...
    "credit.street": "Street Address",
    "credit.city": "City",
    "credit.state": "State",
    "credit.selectState": "Select state…",
    "credit.zip": "ZIP Code",
    "credit.country": "Country",
    "credit.countryNote":
      "Credit terms are exclusively available for US-based businesses.",
  ...
  es: {
    ...
    "dashboard.valuedCustomer": "Cliente Valioso",
    "dashboard.greetingSubtitle":
      "Aquí tienes un resumen rápido de tu cuenta comercial y oportunidades abiertas.",
    "dashboard.promoCarouselLabel": "Anuncios de la cuenta",
    "dashboard.promoEyebrow": "Novedades Plastipac",
    "dashboard.promoSlide": "Diapositiva",
    "dashboard.promo1Title": "Ofertas B2B exclusivas",
    "dashboard.promo1Body":
      "Hasta 15% de descuento en pedidos al mayoreo de película máquina.",
    "dashboard.promo1Cta": "Ver película máquina",
    "dashboard.promo2Title": "Envío rápido en EE. UU.",
    "dashboard.promo2Body":
      "Despacho garantizado en 48 horas a todos los estados.",
    "dashboard.promo2Cta": "Explorar catálogo",
    "dashboard.promo3Title": "Línea de crédito Net 30 disponible",
    "dashboard.promo3Body": "Solicita hoy financiamiento flexible.",
    "dashboard.promo3Cta": "Solicitar crédito",
    "dashboard.creditSlideBadge": "Crédito Comercial",
    "dashboard.creditSlideTitle": "Solicita Crédito B2B y Términos Net 30",
    "dashboard.creditSlideSubtitle":
      "Optimiza pedidos de alto volumen con líneas de crédito dedicadas, pago con PO y términos Net 30 para cuentas verificadas.",
    "dashboard.creditSlideCta": "Iniciar Solicitud de Crédito",
    "dashboard.creditSlideBrowse": "Explora el catálogo mientras aplicas →",
    "dashboard.sampleSlideBadge": "Muestra Gratis",
    "dashboard.sampleSlideTitle": "Solicita tu Rollo de Muestra Gratis",
    "dashboard.sampleSlideSubtitle":
    ...
    "admin.bentoFulfillmentSubtitle": "Despachos de flete en EE. UU. activos y estado del patio",
    ...
    "products.rollLength": "Longitud del Rollo",
    "products.allLengths": "Todas las Longitudes",
    "products.filmWidth": "Ancho de Película",
    "products.allWidths": "Todos los Anchos",
    ...
    "products.directCheckout": "Ir al Checkout Directo",
    ...
    "credit.street": "Calle y Número",
    "credit.city": "Ciudad",
    "credit.state": "Estado",
    "credit.selectState": "Seleccionar estado…",
    "credit.zip": "Código Postal",
    "credit.country": "País",
    "credit.countryNote":
      "Los términos de crédito están disponibles exclusivamente para empresas con sede en EE. UU.",
