          ...
          <div className="max-w-3xl mx-auto text-center space-y-5">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-6 py-3.5 text-sm font-extrabold text-[#0F172A] shadow-lg shadow-blue-950/30 hover:bg-sky-50 transition-colors cursor-pointer"
              >
                Request Free Sample
