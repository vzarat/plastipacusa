...
export const metadata: Metadata = {
  ...
  description:
    "Leading US manufacturer of industrial cast stretch film, high-yield machine film, and sustainable PCR packaging solutions. Factory-direct pallet and truckload pricing.",
  keywords: [
    "stretch film",
    "pallet wrap",
